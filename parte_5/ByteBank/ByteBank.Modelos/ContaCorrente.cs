...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        /// <exception cref="SaldoInsuficienteException"> Exceção lançada quando o valor do saque é maior que o saldo em conta utilizado no argumento <paramref name="valor"/>. </exception>
